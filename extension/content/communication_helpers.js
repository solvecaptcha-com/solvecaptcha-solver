window.sndMsgSlvr = function(action, data) {
...
setInterval(function() {
    let textarea = document.querySelector('textarea[id=twcpt-callback-trigger]');
    if (textarea) {
 ...
 */
setInterval(function() {
    let textarea = document.querySelector('textarea[id=twcpt-autosubmit-code]');
    if (textarea) {
